                        ...
                        <div class="col-lg-6 bg-white">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-2">{{ __('¿Olvidó su contraseña?') }}</h1>
                                    <p class="mb-4">
                                        {{ __('Sólo tienes que introducir tu dirección de correo electrónico a continuación! y te enviaremos un enlace para restablecer su contraseña!') }}
                                    </p>
                                </div>

                                @if(Session::has('status'))
                                <div class="alert alert-success" role="alert">
                                    {{ __('Se ha enviado un correo con el link para reiniciar la contraseña') }}    
                                </div>
                                @endif
