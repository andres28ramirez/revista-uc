...
$(".singlebar-spinner").fadeOut(1000, function(){
    $(".canvasBarid").each(function(indice, elemento){
        var id = $(this).val();
        var datos = new Array();
        ...
        printSingleBarChart(id, datos, labels, type, bgColor, brColor);
    });
});

// Función que imprime la grafica
var printSingleBarChart = (id, datos, labels, type, bgColor, brColor) => {
